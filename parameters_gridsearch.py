...
param_grid_rfc = {'n_estimators': [10],
                  'max_depth': [25],
                  'max_features': ['auto'],
                  'max_leaf_nodes': [None],
...
param_grid_xgbc = {'colsample_bylevel' : [0.5],
...
param_grid_rfr = {'n_estimators': [10],
                  'max_depth': [25],
                  'max_features': ['auto'],
                  'max_leaf_nodes': [None],
...
param_grid_xgbr = {'colsample_bylevel' : [0.5],
                   'colsample_bytree' : [0.9],
                   'gamma' : [0.0007],
                   'learning_rate' :[0.5],
                   'max_delta_step' : [0],
